...
<html lang="fr">
  ...
  <body>
	...
	<br />
        <p>Ton solde payutc est de : <strong><?php echo format_amount($SADMIN->getCredit()); ?> €</strong></p>
      </div>
      <div class="row">
        <div class="span4" >
          <h2>Historique</h2>
        ...
        <div class="span4">
          ...
          <div class="alert alert-success">
           ...
           <div class="input-prepend input-append">
							...
							<input name="montant" type="number" class="span1" min="<?php echo$CONF['rechargement_min']?>" max="<?php echo$CONF['rechargement_max']?>" value="<?php echo$reload_value?>" step="0.01" />
